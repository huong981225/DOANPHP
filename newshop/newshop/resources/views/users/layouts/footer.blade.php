					...
					<div class="company-facality-row">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="single-facality">
								...
								<div class="facality-text">
									...
									<span>Hóa đơn trên 300 000 VNĐ</span>
								</div>
							</div>
						</div>
						<!-- SINGLE-FACALITY END -->
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="single-facality">
								...
								<div class="facality-text">
									<h3 class="facality-heading-text">CẬP NHẬT</h3>
									<span>Kiểm tra cửa hàng mới nhất</span>
								</div>
							</div>
						</div>
						<!-- SINGLE-FACALITY END -->
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="single-facality">
								...
								<div class="facality-text">
									<h3 class="facality-heading-text">Chất lượng</h3>
										...
										<div class="Store-Information">
											...
											<ul>
												...
												<li>
													...
													<div class="info-text">
														<p>Email : <a href="mailto:sales@yourcompany.com"><i class="fa fa-angle-double-right"></i> {{$company->email}}</a></p>
													</div>
												</li>
											</ul>
										</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										...
										<div class="google-map-area">
											<div class="google-map">
												<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.674055136489!2d106.5968250142869!3d10.759584162447693!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752c4ed0bce16f%3A0xdbee4a7d0b2925a5!2zTMOqIMSQw6xuaCBD4bqpbiwgQsOsbmggVMOibiwgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1591705023796!5m2!1svi!2s" width="100%" height="250px" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
											</div>
										</div>
										<!-- GOOGLE-MAP-AREA END -->
									</div>
