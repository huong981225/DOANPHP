...
class NewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     DB::table('news')->insert([
           ...
           'content' => 'Bánh đậu xanh trái cây Thái Lan hay còn gọi là Look choup là món ăn vặt thơm ngon ở đường phố Thái Lan. Bánh được tạo hình thành các loại hoa quả đẹp mắt như cam, xoài, dâu, măng cụt… Bạn hoàn toàn có thể tự làm món bánh này ở nhà để thay đổi khẩu vị cho gia đình, đặc biệt là các bé sẽ rất thích nhé!..',           
           'image'=>'luk-chup.jpg',   
           'status'=>rand(0,1),    
            'created_at' => date("Y-m-d"),
            'updated_at' => date("Y-m-d")
